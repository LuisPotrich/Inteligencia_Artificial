...
def generateAWord (length):
	...
	result = ""
	while i < length:
		letter = chr(48 + int(10 * random.random()))
		result += letter
		i +=1
	return result
...
"Rotinas explicadas separadamente"
...
def mutateWord(word):
	...
	if (index_modification == 0):
		word = chr(48 + int(10 * random.random())) + word[1:]
	else:
		word = word[:index_modification] + chr(48 + int(10 * random.random())) + word[index_modification+1:]
	return word
